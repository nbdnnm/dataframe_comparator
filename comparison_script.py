...
indexes_only_in_first, indexes_only_in_second = columns_which_are_only_in_one_file(columns_statistics_filename,
                                                                                   first_file_dataframe,
...
columns_comparison = find_differences_in_values_per_indexes_and_column(columns_statistics_filename, first_file_dataframe,
                                                                       second_file_dataframe)
